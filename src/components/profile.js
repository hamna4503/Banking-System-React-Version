...
function Profile() {
  return (
      <div class="container mt-5 mb-5">
        <h1 className='text-center text-dark '>Profile #123</h1>
        <div className='profile-grid'>
          <img className='profile-img img-fluid img-thumbnail' src={person1}/>
          <div className='profile-info text-dark p-5'>
